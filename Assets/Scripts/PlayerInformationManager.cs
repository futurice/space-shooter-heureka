...
public class PlayerInformationManager : Singleton<PlayerInformationManager>
{
	Dictionary<int, PlayerInformation> _playerInformationMap = new Dictionary<int, PlayerInformation> ()
	{
		...
		{4, new PlayerInformation ("X-WING", 			new Color (255.0f/255.0f, 130.0f/255.0f, 126.0f/255.0f), 	"Prefabs/Player/4", "Sprites/PlayerShipSilhouettes/4", "Prefabs/PlayerExplosions/explosion_projectile_4")},
